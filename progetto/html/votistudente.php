    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: rgba(0, 0, 0, 0.5);">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item">
              <a class="nav-link" href="esamistudente.php">Esami</a>
            </li>
            <li class="nav-item active">
              <a class="nav-link" href="#">Voti<span class="sr-only">(current)</span></a>
            </li>
          </ul>
          <div class="btn-group">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a class="dropdown-item" href="logout.php">
                <svg width="20px" height="20px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 336.28 425"><defs><style>.cls-2{fill:none;stroke:white;stroke-miterlimit:10;stroke-width:40px;}</style></defs><title></title><g id="Livello_2" data-name="Livello 2"><g id="Livello_1-2" data-name="Livello 1"><polyline class="cls-2" points="231 20 20 20 20 405 231 405"/><polyline class="cls-2" points="54 213 288 213 236.5 161.5"/><polyline class="cls-2" points="54 213 288 213 236.5 264.5"/><line class="cls-2" x1="252.5" y1="177.5" x2="288.5" y2="213.5"/><line class="cls-2" x1="258" y1="243" x2="292" y2="210"/></g></g></svg>
              Logout</a>
          </div>
          </div>
        </div>
